"""Regression checks for the onyx-sec-policy-vault casebook."""
...
from casebook.harness import assert_expected, onyx_sec_policy_vault_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(onyx_sec_policy_vault_summary(), assert_expected())
